...
{
    private:
        ROOT::Math::XYZPoint *m_position = new ROOT::Math::XYZPoint;
        ROOT::Math::XYZPoint *m_previous_position = new ROOT::Math::XYZPoint;
        ROOT::Math::XYZVector *m_velocity = new ROOT::Math::XYZVector;
        bool m_alive;
        double m_created;
        double m_lifetime;
    ...
    public:
        ...
        Particle(ROOT::Math::XYZPoint start, ROOT::Math::XYZVector velocity, double created = 0)
        {
        ...
        ROOT::Math::XYZPoint *PositionPointer()
        {
            return(m_position);
        }

        ROOT::Math::XYZVector Velocity()
        {
            return(*m_velocity);
        }
...
{
    ROOT::Math::XYZPoint p1( 1, 0, 0);
    p1 = p1*(xwidth/2);
    ROOT::Math::XYZPoint p2( 0, 1, 0);
    p2 = p2*(ylength/2);
    ROOT::Math::XYZPoint p3( 0, 0, 1);
    p3 = p3*(zheight/2);
    ROOT::Math::XYZPoint p4(-1, 0, 0);
    p4 = p4*(xwidth/2);
    ROOT::Math::XYZPoint p5( 0,-1, 0);
    p5 = p5*(ylength/2);
    ROOT::Math::XYZPoint p6( 0, 0,-1);
    p6 = p6*(zheight/2);

    ROOT::Math::XYZVector n1(-1, 0, 0);
    ROOT::Math::XYZVector n2( 0,-1, 0);
    ROOT::Math::XYZVector n3( 0, 0,-1);
    ROOT::Math::XYZVector n4( 1, 0, 0);
    ROOT::Math::XYZVector n5( 0, 1, 0);
    ROOT::Math::XYZVector n6( 0, 0, 1);
    p1 = p1 + xpos*n4;
    p2 = p2 + ypos*n5;
    p3 = p3 + zpos*n6;
    p4 = p4 + xpos*n4;
...
{
    ROOT::Math::XYZPoint p1(0,0,-2.5);
    ROOT::Math::XYZPoint p2(0,0,2.5);
    ROOT::Math::XYZPoint p3(3.15, 0, 0);
    ROOT::Math::XYZPoint p4(-3.15, 0, -2.5);
    ROOT::Math::XYZPoint p5(0, 3.105, 0);
    ROOT::Math::XYZPoint p6(0, -3.105, 0);
...
Threedpolygon* Backstop()
{
    ...
    ROOT::Math::XYZPoint p3(3.15+9.60, 0, 0);
    ROOT::Math::XYZPoint p4(-3.15-9.60, 0, -2.5);
    ROOT::Math::XYZPoint p5(0, 160, 0);
    ROOT::Math::XYZPoint p6(0, -160, 0);
...
class Tile
{
    ...
    public:
        Tile(ROOT::Math::XYZPoint position, double theta_x, double theta_y, double theta_z, bool is_edge)
        {
        ...
        void AddParticle(ROOT::Math::XYZPoint position, ROOT::Math::XYZVector velocity, double timedelay)
        {
        ...
        void PathFindParticle(Particle *particle, double time) //cannot do recursive function because of excessive use of pointers
        {
            ...
            ROOT::Math::XYZPoint projection = particle->Project(time);
            while (!m_scintillator->HasInsideStrict(&projection))
            {
                Line line;
                line.point = particle->Position();
                line.vector = particle->Velocity();
                ROOT::Math::XYZPoint bounce_point = m_scintillator->FirstPositiveIntersection(&line);
                ...
                particle->Move(dt);
                ///*
                ROOT::Math::XYZPoint temp_position = particle->Position();
